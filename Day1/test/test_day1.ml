...
let%expect_test "Day1Part1 Sim" = 
  Harness.run_advanced ~waves_config ~create:Day1.hierarchical testbench;
  [%expect {|
    ("Complete. " (final_count 1097))
    Saved waves to /tmp/test_day1_ml_Day1Part1_Sim.hardcamlwaveform
    |}]
;;